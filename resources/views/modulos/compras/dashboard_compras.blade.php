                        ...
                        <form action="{{route('alta_oc')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-2 form-group">
                                    ...
                                    <input class="form-control" id="oc" name="oc" placeholder="" value="{{$ultima+1}}" type="text" readonly>
                                </div>
                                ...
                                <div class="col-md-1 form-group">
                                    <label></label>
                                    <button class="btn btn-primary btn-block" type="submit"><i class="icon-plus">Agregar</i></button>
                                </div>
                            </div>
                        </form>
                                        ...
                                        <div class="table-wrap">
                                            <table id="datable_1" class="table table-hover w-100 display pb-30">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#edicion_material" data-id="{{$material->id}}" data-descripcion="{{$material->descripcion}}" data-cantidad="{{$material->cantidad_solicitada}}">
                                                                <i class="icon-pencil"> Asignar</i>
                                                            </button>
                                                        </td>
                                                        <td>{{$material->ot}}</td>
                                                        <td>{{$material->tipo}}</td>
