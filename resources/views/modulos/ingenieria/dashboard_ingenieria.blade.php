        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <div class="main-wrapper">
                    ...
                    <a href="{{route('dibujos_exports')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Generar reporte</a>
                </div>
                <!-- /Title -->
                <div class="row">
                    <div class="col-xl-12">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td style="width: 200px;">
                                                        <button type="button" class="btn btn-primary btn-sm"  data-toggle="modal" data-target="#cargar_dibujo" data-ot="{{$dibujo->ot}}">
                                                            <i class="icon-plus">Cargar</i>
                                                        </button>
                                                    </td>
                                                    <td>{{$dibujo->ot}}</td>
                ...
                <div class="modal fade" id="cargar_dibujo" tabindex="-1" role="dialog" aria-labelledby="exampleModalForms" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{route('carga_dibujo')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <input class="form-control" id="dibujo" name="dibujo" placeholder="" value="" type="file">
                                        </div>
                                    </div>
                                    <br>
