...
<body>
    ...
    <!-- jQuery -->
    <script src="../Plantilla/html/vendors/jquery/dist/jquery.min.js"></script>

    <!-- Bootstrap Core JavaScript -->
    <script src="../Plantilla/html/vendors/popper.js/dist/umd/popper.min.js"></script>
    <script src="vendors/bootstrap/dist/js/bootstrap.min.js"></script>

    <!-- Slimscroll JavaScript -->
    <script src="../Plantilla/html/dist/js/jquery.slimscroll.js"></script>
