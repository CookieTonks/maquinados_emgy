...
class embarques_controller extends Controller
{
    ...
    public function salida_tratamiento(Request $request)
    {
        if ($request->tipo_salida == 'Remision') {
            ...
            $registro_emgy->movimiento = 'EMBARQUES - REMISION';
        ...
        if ($request->tipo_salida == 'Factura') {
            ...
            $registro_emgy = new models\emgy_registros();
            $registro_emgy->ot = $request->ot;
            $registro_emgy->movimiento = 'EMBARQUES - FACTURACIÓN';
            $registro_emgy->responsable = Auth::user()->name;
            $registro_emgy->save();
            ...
            $rutas_emgy->sistema_embarques = 'DONE';
            $rutas_emgy->save();
    ...
    public function regreso_tratamiento($orden_tratamiento)
    {
        ...
        $registro_emgy = new models\emgy_registros();
        $registro_emgy->ot = $tratamiento->ot;
        $registro_emgy->movimiento = 'TRATAMIENTO - EMBARQUES';
        $registro_emgy->responsable = Auth::user()->name;
        $registro_emgy->save();
